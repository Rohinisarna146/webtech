Q1 TO SEE RESPONSE OR REQUEST FORMAT - open devtools (developer tools ) press shift + control +I go to network then name the headers now you can see response and request formats
